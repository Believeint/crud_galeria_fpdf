...
<div class="navbar navbar-default navbar-static-top" role="navigation">
    <div class="container">
        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="#" title='Programming Blog'>Lista de Usuários</a>
...
<div class="container">
	...
	<div class="page-header">
    	<h1 class="h2">Perifs de Usuários <a class="btn btn-default" href="addNovo.php" style="float:right;"> <span class="glyphicon glyphicon-plus"></span> &nbsp; Adicionar Novo Perfil</a></h1>
    </div>
...
$stmt = $DB_con->prepare('SELECT idUsuario, nomeUsuario, profissaoUsuario, imagemUsuario FROM tbl_usuario ORDER BY idUsuario DESC');
$stmt->execute();
...
if ($stmt->rowCount() > 0) {
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        ?>
			<div class="col-xs-3">
				<p class="page-header"><b><?php echo $nomeUsuario . "&nbsp;/&nbsp;" . $profissaoUsuario; ?></B></p>
				<img src="imagem_usuarios/<?php echo $row['imagemUsuario']; ?>" class="img-rounded" width="250px" height="250px" />
				<p class="page-header">
				<span>
				...
				<a class="btn btn-danger" href="?delete_id=<?php echo $row['idUsuario']; ?>" title="Clique para deletar" onclick="return confirm('Tem certeza que deseja editar ?')"><span class="glyphicon glyphicon-remove-circle"></span> Deletar</a>
                <a class="btn btn-success" href="pdf.php?gerar_pdf=<?php echo $row['idUsuario']; ?>" target="_blank" title="Gerar PDF" onclick="return confirm('Deseja gerar um PDF para o perfil ?')"><span class="glyphicon glyphicon-remove-circle"></span>PDF</a>
				</span>
				</p>
			</div>
			<?php
